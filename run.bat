...
set "LAST_PATH_FILE=%BASE_APPDATA%\MindustryToolMod\lastpath.txt"

:: Ensure folder for storing last path exists
if not exist "%BASE_APPDATA%\MindustryToolMod" (
    mkdir "%BASE_APPDATA%\MindustryToolMod"
)
...
if exist "%TARGET_FILE%" (
    del "%TARGET_FILE%"
    echo Da xoa %TARGET_FILE%
) else (
    echo File %TARGET_FILE% khong ton tai.
)
